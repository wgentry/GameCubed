...
volatile uint8 I2CM_state;  /* Current state of I2C FSM */
    ...
    *
    *
    *  Configures the I2CM for I2C operation.
    *
    *  This function is intended specifically to be used when the I2CM 
    *  configuration is set to “Unconfigured I2CM” in the customizer. 
    *  After initializing the I2CM in I2C mode using this function, 
    *  the component can be enabled using the I2CM_Start() or 
    * I2CM_Enable() function.
    ...
    *******************************************************************************/
    void I2CM_I2CInit(const I2CM_I2C_INIT_STRUCT *config)
    {
        ...
        else
        {
            ...
            I2CM_INTR_MASTER_MASK_REG = I2CM_NO_INTR_SOURCES;
...
/*******************************************************************************
* Function Name: I2CM_I2CFwBlockReset
****************************************************************************//**
*
* Resets the scb IP block and I2C into the known state.
*
*******************************************************************************/
void I2CM_I2CFwBlockReset(void)
{
